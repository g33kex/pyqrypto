...
import random
from pyqrypto.rOperations import (
    rCircuit,
    make_circuit,
    run_circuit,
    rDKRSCarryLookaheadAdder,
    rOperation,
    rAppend,
    rXOR,
    rROR,
)
from qiskit import QuantumRegister, AncillaRegister, QuantumCircuit  # type: ignore
...
def showcase_basic_xor():
    """Showcase how to use the vectorized XOR operation"""
...
def showcase_add():
    """Showcase how to use the vectorized add operation"""
